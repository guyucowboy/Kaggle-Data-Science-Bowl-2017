...
def process_unlabeled_data(patient,img_px_size=50, hm_slices=20, visualize=False):
...
np.random.shuffle(much_data)
np.save('muchdatanew-{}-{}-{}.npy'.format(IMG_SIZE_PX,IMG_SIZE_PX,SLICE_COUNT), much_data)
