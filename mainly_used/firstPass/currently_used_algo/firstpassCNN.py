...
much_data = np.load('muchdataper-50-50-20-0.7.npy')
...
def train_neural_network(x):
    ...
    with tf.Session() as sess:
        ...
        # Write to CSV
        f = open('stage1_submission'+ str(IMG_SIZE_PX) + '_' + str(SLICE_COUNT) + '_0.5' + '.csv', 'wt')
        writer = csv.writer(f)
...
def score_cal():
	...
	result = pd.read_table('stage1_submission'+ str(IMG_SIZE_PX) + '_' + str(SLICE_COUNT) + '_0.5' + '.csv', sep=',', index_col = 0)
